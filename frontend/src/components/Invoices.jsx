...
export default function Invoices() {
  ...
  const handleEdit = (invoice) => {
    ...
    setFormData({ customer_id: invoice.customer_id, invoice_number: invoice.invoice_number, amount: invoice.amount.toString(), due_date: invoice.due_date, currency: invoice.currency || "TRY", notes: invoice.notes || "" });
    setDialogOpen(true);
  };
  ...
  const resetForm = () => {
    setFormData({ customer_id: "", invoice_number: "", amount: "", due_date: "", currency: "TRY", notes: "" });
